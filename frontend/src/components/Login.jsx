        ...
        {display === 0 ? (
            ...
            sx={{ fontFamily: "'Roboto', sans-serif" }}>
                <VStack spacing={4} align="flex-start">
                    <Button bg="gray" size="lg" color="white" width="full" onClick={() => setDisplay(1)}>
                        Log in
                    </Button>
                    <Button bg="gray" size="lg" color="white" width="full" onClick={() => setDisplay(2)}>
                        Sign up
                    </Button>
                </VStack>
            </Box>
        ...
        sx={{ fontFamily: "'Roboto', sans-serif" }}>
            <form onSubmit={handleSubmit}>
                <VStack spacing={4} align="flex-start">
                    {display === 2 &&
                        <FormControl>
                        <FormLabel htmlFor="name" fontWeight="light">Name</FormLabel>
                        <Input
                            id="name"
                            type="name"
                            value={username}
                    ...
                    <FormControl>
                        <FormLabel htmlFor="email" fontWeight="light">Email</FormLabel>
                        <Input
                            id="email"
                            type="text"
                            value={email}
