...
function CheckoutPage(props) {
  const [items, setItems] = useState(["1025 Dokdo Cleanser", "mixsoon Bean Essence"])
      ...
      <Box key={index} justifyContent="space-between" p="5">
          ...
          >
            ...
            <VStack width = "55%" alignItems="left">
              ...
              <Text fontSize="15px"> Slightly acidic (pH 5.0 - 6.0), foamy and creamy cleanser purifies and removes excess sebum without over-drying. It clears away impurities and helps the skin maintain a healthy moisture balance. </Text>
        ...
        >
          ...
          <VStack marginTop = "25px" alignItems="left" marginLeft = "50px">
            <Box display="flex" justifyContent="space-between">
              <Text fontWeight="200" color="black">Sociolla Total: </Text>
              <Box textAlign="right" marginRight = "50px">
                <Text fontWeight="200" color="black">$13.60 </Text>
              </Box>
            </Box>
            <Box display="flex" justifyContent="space-between">
              <Text fontWeight="200" color="black">Sephora Total: </Text>
              <Box textAlign="right" marginRight = "50px">
                <Text fontWeight="200" color="black">$0 </Text>
              </Box>
            </Box>
            <Box display="flex" justifyContent="space-between">
              <Text fontWeight="200" color="black">Amazon Total: </Text>
              <Box textAlign="right" marginRight = "50px">
                <Text fontWeight="200" color="black">$0 </Text>
              </Box>
            </Box>
          ...
          <VStack marginTop="25px" alignItems="left" marginLeft="50px">
            <Box display="flex" justifyContent="space-between">
              <Text fontWeight="200" color="black">Total Before Tax: </Text>
              <Box textAlign="right" marginRight = "50px">
                <Text fontWeight="200" color="black">$13.60 </Text>
              </Box>
            </Box>
            <Box display="flex" justifyContent="space-between">
              <Text fontWeight="200" color="black">Estimated Tax: </Text>
              <Box textAlign="right" marginRight = "50px">
                <Text fontWeight="200" color="black">$1.69 </Text>
              </Box>
            </Box>
          </VStack>
          ...
          <Box textAlign="center">
            <Text fontWeight="200" color="black" marginTop="10px">Order Total: $15.29</Text>
          </Box>
