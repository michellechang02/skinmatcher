...
const Profile = () => {
  ...
  const {
    isOpen: isEditSkinProfileOpen,
    onOpen: onEditSkinProfileOpen,
    onClose: onEditSkinProfileClose,
  } = useDisclosure();
  const {
    isOpen: isEditPreferencesOpen,
    onOpen: onEditPreferencesOpen,
    onClose: onEditPreferencesClose,
  } = useDisclosure();
  const {
          ...
          <SimpleGrid columns={2} spacing={10}>
            ...
            <Stack spacing={3}>
              ...
              <HStack>
                ...
                <Button width="75px" colorScheme="gray" onClick={logout}>
                  Logout
                </Button>
              </HStack>
            </Stack>
